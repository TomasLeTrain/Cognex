...
#define LEFT_SHIFT pros::E_CONTROLLER_DIGITAL_RIGHT
#define RIGHT_SHIFT pros::E_CONTROLLER_DIGITAL_Y
...
void setColorSortEnabled(bool enabled) { colorSortEnabled = enabled; }

// code that should run during driver
void driverUpdate() {
  // update states based on driver input
  bool intakeToBackpack = controller.get_digital(L1);

  bool scoreBottomHeight = controller.get_digital(L2);
