...
void run_auton() {
    ...
    mb.moveTo(-24, 23.4 * l).drive_vel_mp_setMaxAccel(80_inps2) | chain;
    ...
    if (bl) {
        ...
        // chain.waitUntil(closeEnough({ -11.5_in, 11.0_in * l }, 4_in));
        // // give time for balls to go towards the top
        // pros::delay(500);
        //
        // // start scoring
